...
const Navbar = () => {
  return /* @__PURE__ */ jsxs("div", { style: { padding: "10px" }, className: "border-b-0", children: [
...
function Sidebar() {
  return /* @__PURE__ */ jsxs("div", { className: " pl-5 pt-8  mr-2 w-15 flex flex-col border-r-1 ", children: [
...
//# sourceMappingURL=_layout-Lyr9J-to.mjs.map
