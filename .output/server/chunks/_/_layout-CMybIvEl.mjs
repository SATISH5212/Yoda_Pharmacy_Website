...
const Navbar = () => {
  return /* @__PURE__ */ jsxs("div", { style: { padding: "8px" }, className: "border-b-1", children: [
...
function Sidebar() {
  return /* @__PURE__ */ jsxs("div", { className: " pt-8 w-12 flex flex-col items-center border-r-1", children: [
