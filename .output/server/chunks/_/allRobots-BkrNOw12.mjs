...
const BASE_URL$1 = "https://demetercloud.onrender.com/v1.0";
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "flex gap-2 h-61", children: [
                    ...
                    children: (field) => {
                      ...
                      return /* @__PURE__ */ jsxs(
                        "select",
                        {
                          ...
                          required: true,
                          children: [
                            /* @__PURE__ */ jsx("option", { value: "", children: "Robot Type" }),
                            isLoading ? /* @__PURE__ */ jsx("option", { value: "", children: "Loading..." }) : (_a = data == null ? void 0 : data.products) == null ? void 0 : _a.map((info) => /* @__PURE__ */ jsx("option", { value: info.id, children: info.brand }, info.id))
                          ]
                        }
                      );
                    }
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2 p-2 border-1 rounded-xl w-130 h-31", children: [
...
function AllRobots() {
  ...
  const total = [];
  if (data) {
    for (let i = 1; i <= (data == null ? void 0 : data.pagination_info.total_records) / page_size; i++) {
      total.push(i);
    }
  }
  if (isLoading) return /* @__PURE__ */ jsx("p", { children: "Loading robots..." });
  if (isError) return /* @__PURE__ */ jsx("p", { children: "Error: " });
  console.log(data);
  return showAddRobot ? /* @__PURE__ */ jsx(AddRobot, { onBack: () => setShowAddRobot(false) }) : /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs("div", { className: "bg-gray-200 rounded p-1 mb-2 w-full relative", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "bg-gray300", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 p-0.5  text-xs  absolute bottom-0 right-1", children: [
...
//# sourceMappingURL=allRobots-BkrNOw12.mjs.map
