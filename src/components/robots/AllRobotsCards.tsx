        ...
        <div className='flex flex-col item-center mb-4'>
          <div className='flex flex-row justify-between'>
            ...
            <div className='flex items-center gap-x-2' >
              <span className=''><img src="/assets/robots/robotNotifications.svg" alt="Robot" className="w-5 h-5" /></span>
              <span className=''><img src="/assets/robots/robotNetwork.svg" alt="Robot" className="w-5 h-5" /></span>
            </div>
          </div>
          ...
          <li className="flex justify-between items-center">
            <span className='flex w-1/2 gap-3'>
              <span className="flex flex-row items-center justify-center font-normal">
                <img src="/assets/robots/battery.svg" alt="Robot" className="w-5 h-5 mr-1" /> Battery</span>
              <span className='flex items-center text-sm font-normal '>85%</span>
            </span>

            <span className='flex w-1/2 gap-3 justify-end items-center'>
              <span className="flex flex-row font-semibold"><img src="/assets/robots/efficiency.svg" alt="Robot" className="w-5 h-5" />
