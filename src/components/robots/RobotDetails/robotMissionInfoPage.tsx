            ...
            <div className="space-y-1">
                <div className="flex justify-between" >
                    ...
                    <span className=" flex space-x-2 items-center">
                        <span className="flex text-xs justify-between  h-[23px] rounded-md border-1 py-1 px-2 border-black hover:bg-gray-100 hover:cursor-pointer items-center"><img src="/public/assets/robots/robotMissionInfo/downloadIcon.svg" alt="download" className="flex w-[13px] h-[13px] self-center mr-1 " />Download Report</span>
                        <span className="flex text-xs justify-between  h-[23px] rounded-md border-1 py-1 px-2 border-black hover:bg-gray-100 hover:cursor-pointer items-center"><img src="/public/assets/robots/robotMissionInfo/shareIcon.svg" alt="share" className="w-[13px] h-[13px]" />Share Results</span>
                        <span className="flex text-xs justify-between  h-[23px] rounded-md border-1 py-1 px-2 border-black hover:bg-gray-100 hover:cursor-pointer items-center"><img src="/public/assets/robots/robotMissions/alert.svg" alt="alerts" className="w-[13px] h-[13px]" />Alerts</span>
                    </span>
                </div>
                <div className="flex justify-between bg-[#F2F2F2] items-center p-1 py-2 rounded-sm">
                    ...
                    <span className="flex items-center justify-between gap-4 font-medium">
                        <span className="flex items-center text-xs gap-1"><img src="/public/assets/robots/robotsDetails/calander.svg" alt="calander" className="w-[13px] h-[13px]" /> Completed: June 12,2025 - 15:15 PM</span>
                        <span className="flex items-center text-xs gap-1"><img src="/public/assets/robots/robotTimer.svg" alt="timer" className="w-[13px] h-[13px]" /> Total Duration: 8hr 45m</span>
                    </span>
                </div>
            ...
            <div className="flex-row">
                <Tabs value={activeTab} onValueChange={handleTabChange} defaultValue="mission-details">
                    <TabsList className="flex-shrink-0  rounded-md bg-[#D6D6D6] p-0 h-[23px] border-1  gap-3">
                        ...
                        >
                            <img src="/public/assets/robots/robotMissionInfo/missionDetailsIcon.svg" alt="missionDetails" className="w-[15px] h-[15px]" />Mission Details
                        </TabsTrigger>
                        <TabsTrigger
                            value="timeline"
                            className={`flex items-center gap-1 text-xs px-2  h-full 
                        ...
                        >
                            <img src="/public/assets/robots/robotMissions/Alert.svg" alt="timeline" className="w-[15px] h-[15px]" /> Timeline
                        </TabsTrigger>
                        <TabsTrigger
                            value="analytics"
                            className={`flex items-center gap-1 text-xs px-2  h-full  
                        ...
                        >
                            <img src="/public/assets/robots/efficiency.svg" alt="analytics" className="w-[15px] h-[15px]" /> Analytics
                        </TabsTrigger>
                        <TabsTrigger
                            value="alerts"
                        ...
                        >
                            <img src="/public/assets/robots/robotMissions/Alert.svg" alt="timeline" className="w-[15px] h-[15px]" />Alerts
                        </TabsTrigger>
                    </TabsList>
                    <TabsContent value="mission-details" className="flex-grow p-2 rounded shadow-sm">
                        <div className="flex flex-col">
                            <div className="flex items-center   text-sm font-semibold  gap-2"><img src="/public/assets/robots/robotMissionInfo/assignedRobotsIcon.svg" alt="multi-users" className="w-[13px] h-[13px]" />Assigned Robots (2)</div>
                            <div className="flex justify-between p-2 gap-4 ">
                                <span className="flex justify-between items-center w-full border rounded-md pb-2 pt-1">
                                    ...
                                    <span><img src="/public/assets/robots/robotMissionInfo/exclamationIcon.svg" alt="robot" className="w-[15px] h-[15px] m-2 ite" /></span>
                                </span>
                                <span className="flex justify-between items-center w-full border rounded-md pb-2 pt-1">
                                    <span className="flex items-start gap-1 px-2  ">
                                        <div className=" flex  w-2  h-2 bg-green-500 rounded-full mr-1 mt-1.5"></div>
                        ...
                        <div className="mt-3 space-y-2">
                            ...
                            <div className="flex justify-between text-xs">
                                ...
                                <span className="flex items-center gap-4">
                                    ...
                                    <span className="flex  text-[#00763C] rounded-md items-center bg-[#CCFFD5] h-5 py-2 pr-2">
                                        <img src="/public/assets/robots/robotTimer.svg" alt="robot" className="w-[13px] h-[13px] mr-1 ml-3" /> Outstanding</span>
                            ...
                            <div className="flex justify-between text-xs">
                                ...
                                <span className="flex items-center gap-4">
                                    0.2%
                                    <span className="flex  text-[#00763C] rounded-md items-center bg-[#CCFFD5] h-5 py-2 pr-2">
                                        <img src="/public/assets/robots/robotTimer.svg" alt="robot" className="w-[13px] h-[13px] mr-1 ml-3" /> Minimal</span>
                            ...
                            <div className="flex justify-between text-xs">
                                ...
                                <span className="flex items-center gap-4">
                                    A+
                                    <span className="flex  text-[#00763C] rounded-md items-center bg-[#CCFFD5] h-5 py-2 pr-2">
                                        <img src="/public/assets/robots/robotTimer.svg" alt="robot" className="w-[13px] h-[13px] mr-1 ml-3" /> Premium Quality</span>
