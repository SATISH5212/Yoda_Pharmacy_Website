        ...
        <div className='flex flex-col lg:flex-row w-full'>
            <div className='hidden lg:flex lg:flex-col lg:w-[25vw] space-y-4 pr-2 border-r border-gray-200 overflow-y-auto'>
                <div className="flex justify-between items-center px-2 pt-4">
                    ...
                    <img src="/assets/robots/robotMissions/missionSearch.svg" alt="search" className="w-[25px] h-[25px]" />
                </div>
                        ...
                        <div key={i} className="px-2 py-1 space-y-2 border border-gray-200 rounded-md bg-white">
                            <div className="flex justify-between items-center">
                                ...
                                <span className="flex gap-2">
                                    <img src="/assets/robots/robotMissions/alert.svg" alt="alert" className="w-[15px] h-[15px]" />
                                    <img src="/assets/robots/robotMissions/notification.svg" alt="notif" className="w-[15px] h-[15px]" />
                                    <img src="/assets/robots/robotNetwork.svg" alt="network" className="w-[15px] h-[15px]" />
                                    <img src="/assets/robots/robotMissions/battery.svg" alt="battery" className="w-[15px] h-[15px]" />
                                </span>
                            </div>
