...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description
    ref={ref}
    className={cn("text-xs lg:text-sm text-muted-foreground", className)}
    {...props}
  />
));
