    ...
    return (
        <div className="flex flex-col  items-center border-r-1 gap-80px mt-2">
            ...
            <div className="flex flex-col items-center gap-y-6">
                <Link to="/all-fields" className="[&.active]:bg-[#05A155] hover:bg-gray-300 rounded-lg h-10 w-10 flex items-center justify-center">
                    <img src="/src/components/svg/fields/fields.svg" alt="field" className="w-[27px] h-[27px]" />
                </Link>
                <Link to="/all-robots" className="[&.active]:bg-[#05A155] hover:bg-gray-300 rounded-lg h-10 w-10 flex items-center justify-center">
                    <img src="/src/components/svg/robots/all-robots.svg" alt="field" className="w-[24px] h-[24px]" />
                </Link>
                <Link to="/teleop" className="[&.active]:bg-[#05A155] hover:bg-gray-300 rounded-lg h-10 w-10 flex items-center justify-center">
                    <img src="/src/components/svg/teleoperation/teleoperation.svg" alt="field" className="w-[24px] h-[24px]" />
                </Link>
                <Link to="/add-robot" className="[&.active]:bg-[#05A155] hover:bg-gray-300 rounded-lg h-10 w-10 flex items-center justify-center">
